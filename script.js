let btnTextEx = document.querySelector('.next-ex');
let boxTextEx = document.querySelector('.box-text-ex');

let textBefore = document.querySelector('.text-box__before-text'); 
let textAfter = document.querySelector('.text-box__after-text');
...
let spanErrorText = document.getElementsByClassName('error-text');
let inputArea = document.getElementsByClassName('form-box__area');
...
let formValidation = function(e) {
    ...
    if (result == false) {
        document.getElementById('form-box__area__headline').innerText = "Данные не приняты. Введите данные в корректном формате"
    }
    if (result == true) {
        document.getElementById('form-box__area__headline').innerText = "Данные приняты"
    }    
    return result;
};
